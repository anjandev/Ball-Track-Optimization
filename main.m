...
[x_positions, y_positions, velocities, accelerations, time, position, omegas, alphas, omega] = slope(getOldVelocity(0), position, time, [1*INCH_TO_METER, -11*INCH_TO_METER], omega);
...
[omega] = bounce(energy_remain, getOldVelocity(0));

[x_positions4, y_positions4, velocities4, accelerations4, time, omegas4, alphas4] = free(getOldVelocity(0), time, position,position(1)+ 1*INCH_TO_METER, position(2) + 0.1*INCH_TO_METER,-0.889);
% 
